...
export const shadowMessageToolSchemaProperties = {
  ...
  media: optionalSchema(stringSchema('Attachment source URL or local path for send-file.')),
  ...
  buffer: optionalSchema(stringSchema('Base64 attachment payload for send-file.')),
