export const shadowAgentPromptHints = [
  ...
  '- When a Shadow user asks for a file, use the message tool with `action: "upload-file"` plus `target`, `path`/`filePath`/`media` or `buffer`, optional `filename`, `contentType`, and `caption`.',
