...
| Python | `shadow-sdk` | `pip install shadow-sdk` |
...
const client = new ShadowClient('https://your-server.com', 'your-token')
...
client = ShadowClient("https://your-server.com", "your-token")
