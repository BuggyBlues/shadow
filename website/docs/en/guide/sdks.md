...
const client = new ShadowClient('https://your-server.com', 'your-jwt-token')
...
client = ShadowClient("https://your-server.com", "your-jwt-token")
...
socket = ShadowSocket("https://your-server.com", token="your-jwt-token")
...
```python
with ShadowClient("https://your-server.com", "token") as client:
    servers = client.list_servers()
