...
/* Claw Cat with handshake/coin representing rental */
export function ClawCatSvg() {
  return (
    <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-lg">
      {/* Floating Gold Coin */}
      <circle cx="50" cy="20" r="12" fill="#f8e71c" stroke="#1a1a1c" strokeWidth="2.5" />
      <text
        x="50"
        y="26"
        fontSize="16"
      ...
      {/* Multi-person Handshake (Two differently colored hands) */}
      <path
        d="M 20,85 Q 35,75 45,80"
        fill="none"
        stroke="#ff7da5"
        strokeWidth="6"
        strokeLinecap="round"
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      {/* Handshake overlapping part */}
      <circle cx="45" cy="80" r="4.5" fill="#1a1a1c" />
      <circle cx="55" cy="80" r="4.5" fill="#1a1a1c" />
      <path d="M 45,80 L 55,80" fill="none" stroke="#1a1a1c" strokeWidth="3" />
      <path d="M 50,75 L 50,85" fill="none" stroke="#1a1a1c" strokeWidth="3" />
    </svg>
  )
}
