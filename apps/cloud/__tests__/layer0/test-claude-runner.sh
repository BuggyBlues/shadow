#!/usr/bin/env bash
# Layer 0 test: claude-runner container
# Usage: ./tests/layer0/test-claude-runner.sh
#
# Validates:
...
echo "=== Layer 0: claude-runner ==="

# 1. Build image
echo "▸ Building image..."
docker build -t "$IMAGE_NAME" "$PROJECT_DIR/images/claude-runner" --quiet
...
echo ""
echo "=== Layer 0: claude-runner — ALL CHECKS PASSED ==="
