...
export function ShrimpCoinIcon({
  ...
  return (
    ...
    >
      <path
        d="M14 2c-1.54 0-3.08.79-4.24 2.1-1.16 1.3-1.76 3.12-1.76 5v.4A4.8 4.8 0 0 0 5 12c-1.66 0-3 1.34-3 3s1.34 3 3 3h2.64A5.95 5.95 0 0 0 12 22c2.4 0 4.63-1.42 5.53-3.66l1.24-3.1A3 3 0 0 0 18 11.5V10c0-2.65-1.05-5.2-2.93-7.07A9.97 9.97 0 0 0 14 2Z"
        strokeWidth="2"
      />
