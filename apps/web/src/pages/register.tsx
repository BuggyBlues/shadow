...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-deep p-4 relative overflow-hidden font-['Nunito',_'Noto_Sans_SC',_sans-serif]">
      {/* Atmosphere orbs */}
      <div
        className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full opacity-25 blur-[120px] animate-pulse"
        style={{ background: '#FF6B9D' }}
      />
      <div
        className="absolute -bottom-40 -left-40 w-[400px] h-[400px] rounded-full opacity-20 blur-[120px] animate-pulse"
      ...
      <Card variant="glass" className="max-w-md w-full p-10 relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-white/50 text-[15px]">{t('auth.registerSubtitle')}</p>
        </div>
        ...
        <CardContent className="p-0">
          ...
          <Divider label={t('auth.orContinueWith', 'OR')} className="my-6 text-white/30" />
